      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div 
              key={index} 
              className="bg-white p-5 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]"
            >
              <div className="bg-piar-blue/10 p-3 rounded-lg mb-4 flex justify-center">
                <img src={item.image} alt={item.alt} className="h-28 w-auto object-cover rounded" />
              </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-piar-blue/20 to-piar-green/20 p-5 rounded-xl shadow-md max-w-2xl mx-auto transform hover:scale-[1.01] hover:shadow-lg transition-all duration-300">
          <p className="text-xl font-medium text-gray-700 italic text-center">
